...
worldtimeurl = "https://timeapi.io/api/TimeZone/zone?timeZone=Europe/Stockholm"  # Time based on timezone
...
def pulsetoclock(lasttime, a, b):
    ...
    time.sleep(.4)  # 1 second pulse (adjust if necessary)
    clock1(0)
    clock2(0)
